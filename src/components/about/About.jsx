      ...
      <div className="about" id="about">
        <div className="a-left">
          ...
          <div className="a-card">
            <img src="assets/jkblack2.jpg" alt="" className="a-img" />
          </div>
        </div>
        <div className="a-right">
          ...
          <p className="a-desc">
            I am a website developer from Lahore, with a strong focus in UI/UX
            design. I love to get new experiences and always learn from my
            surroundings.Now excited for an internship to use , reproduce and
            grow my skills. Curently working on my own websites , and have
            created three very innovative smoothly working and with attractive
            UI.
          ...
          <div className="a-award">
            ...
            <div className="a-award-texts">
              ...
              <p className="a-award-desc">
                ...
                institute, The Institute Of Emerging Careers, decorated with
                flexible timetable and highly experienced staff.
              </p>
              <Button className="btn1" href="https://iec.org.pk/" download>
                {" "}
                Explore IE <span className="redd">C</span>
              </Button>
            </div>
          </div>
        </div>
